      ...
      <div className="max-w-2xl mx-auto">
        <Card className={"border-emerald-900/20"}>
          <CardHeader className={"text-center"}>
            ...
            <CardTitle className={"text-2xl font-bold text-white txt"}>
              {isRejected
                ? "Verification Declined"
                : "Verification in Progress"}
            </CardTitle>
            <CardDescription className={"text-lg txt"}>
              {isRejected
                ? "Unfotunately, your applicaiton needs revision"
          ...
          <CardContent>
            {isRejected ? (
              <div className="bg-red-900/10 border-red-900/20 rounded-lg p-4 mb-6 flex items-start">
                <AlertCircle
                  className="h-5 w-5 text-red-400 mr-3 mt-0.5 flex-shrink-0
                            "
                />
                <div className="text-muted-foreground text-left txt">
                <p className="mb-2">
              ...
              <div className="bg-amber-900/10 border-amber-900/20 rounded-lg p-4 mb-6 flex items-start txt">
                <AlertCircle className="h-5 w-5 text-amber-400 mr-3 mt-0.5 flex-shrink-0"/>
                <p className="text-muted-foreground text-left txt">
                    Your profile is currently under review by our administrative team. This process typically takes 1-2 business days. You&apos;ll receive an email notification once your account is verified.
                </p>
              </div>
            )}

            <p className="text-muted-foreground txt mb-6">
                {isRejected
